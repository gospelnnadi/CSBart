...
RcppExport SEXP _CSBart_rmvnorm(SEXP meanSEXP, SEXP PrecisionSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _CSBart_choll(SEXP SigmaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _CSBart_update_sigma(SEXP rSEXP, SEXP sigma_hatSEXP, SEXP sigma_oldSEXP, SEXP temperatureSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _CSBart_rlgam(SEXP shapeSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_CSBart_rmvnorm", (DL_FUNC) &_CSBart_rmvnorm, 2},
    {"_CSBart_choll", (DL_FUNC) &_CSBart_choll, 1},
    {"_CSBart_update_sigma", (DL_FUNC) &_CSBart_update_sigma, 4},
    {"_CSBart_rlgam", (DL_FUNC) &_CSBart_rlgam, 1},
    {"_CSBart_CSBart", (DL_FUNC) &_CSBart_CSBart, 33},
    {"_CSBart_do_mh", (DL_FUNC) &_CSBart_do_mh, 4},
    {"_rcpp_module_boot_mod_forest", (DL_FUNC) &_rcpp_module_boot_mod_forest, 0},
    {NULL, NULL, 0}
};

RcppExport void R_init_CSBart(DllInfo *dll) {
