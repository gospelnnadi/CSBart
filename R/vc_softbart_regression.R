#' CSBart Varying Coefficient Regression
#'
...
#' fitted_vc <- vc_csbart_regression(Y ~ . -Z, "Z", df, df_test, opts = opts)
#'
#' ## Plot results
#'
...
#' abline(a = 0, b = 1)
#' 
vc_csbart_regression <- function(formula, linear_var_name, data, test_data,
                                   num_tree = 20, k = 2,
  ...
  class(out) <- "vc_csbart_regression"
