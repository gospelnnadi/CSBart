...
#' fitted_reg <- csbart_regression(Y ~ ., df, df_test, opts = opts)
#' 
#' ## Plot results
#' 
#' plot(colMeans(fitted_reg$mu_test), sim_data$mu_test)
#' abline(a = 0, b = 1)
csbart_regression <- function(formula, data, test_data, num_tree = 20, k = 2, 
