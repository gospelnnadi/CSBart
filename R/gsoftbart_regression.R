...
#' fitted_reg <- gcsbart_regression(Y ~ . - X.4 - X.5, ~ X.4 + X.5, df, df_test, opts = opts)
#' 
#' ## Plot results
#' 
...
gcsbart_regression <- function(formula, linear_formula, data, test_data,
                                 num_tree = 20, k = 2,
                                 hypers = NULL,
