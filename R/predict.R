...
#' Predict for CSBart Regression
#'
#' Computes predictions from a \code{csbart_regression} object on new data.
#' 
#' @param object A \code{csbart_regression} object obtained as output of the \code{csbart_regression()} function.
...
#' @export
#'
predict.csbart_regression <- function(object, newdata, iterations = NULL, ...) {
  stopifnot(class(object) == "csbart_regression")
...
#' Predict for CSBart Probit Regression
#'
#' Computes predictions from a \code{csbart_probit} object for new data.
#' 
#' @param object A \code{csbart_probit} object obtained as output of the \code{csbart_probit} function.
#' @param newdata A dataset to construct predictions on.
...
#' @export
#'
predict.csbart_probit <- function(object, newdata, iterations = NULL, ...) {
  stopifnot(class(object) == "csbart_probit")
  stopifnot(object$opts$cache_trees)
