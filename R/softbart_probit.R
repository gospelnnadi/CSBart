#' CSBart Probit Regression
#' 
#' Fits a nonparametric probit regression model with the nonparametric function
#' modeled using a CSBart model. Specifically, the model takes \eqn{\Pr(Y = 1
...
#' fitted_probit <- csbart_probit(Y ~ ., df, df_test, opts = opts)
#' 
#' ## Plot results
#' 
...
#' 
#' 
csbart_probit <- function(formula, data, test_data, num_tree = 20,
